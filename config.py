...
# V2.0: Thread-safe pipeline (deadlock düzeltildi)
# True: Kornia GPU (8-10x hızlı, thread-safe)
# False: FFmpeg CPU filtreleri (klasik)
KORNIA_GPU_FILTERS = True  # ✅ Kornia GPU aktif
